...
// FIXED: KeyboardAvoidingView + keyboard management for all inputs
...
const styles = StyleSheet.create({
  ...
  textArea: {
    ...
    fontSize: 15, color: '#0f172a', minHeight: 70, textAlignVertical: 'top', marginBottom: 10,
  },
  ...
  modalSheet: { backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, paddingBottom: Platform.OS === 'ios' ? 36 : 28 },
  ...
  pickerModal: { backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, maxHeight: '70%', paddingBottom: Platform.OS === 'ios' ? 36 : 24 },
